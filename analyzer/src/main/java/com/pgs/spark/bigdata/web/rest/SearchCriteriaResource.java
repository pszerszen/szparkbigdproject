...
public class SearchCriteriaResource {
    ...
    public List<SearchCriteriaDTO> getAllSearchCriteria() {
        log.debug("REST request to get all SearchCriteria");
        return searchCriteriaService.findAll();
    }
    ...
    public ResponseEntity<SearchCriteriaDTO> getSearchCriteria(@PathVariable Long id) {
        ...
        SearchCriteriaDTO searchCriteriaDTO = searchCriteriaService.findOne(id);
