...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "analyzer@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "analyzer API";

        private String description = "analyzer API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "analyzer";
