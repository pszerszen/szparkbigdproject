...
public class DocumentResource {
    ...
    produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Map<Long, DocumentDTO>> getDocumentsByIds(@RequestParam("documentsIds") List<Long> documentsIds){
        log.debug("REST request to get list of documents by ids");
        List<DocumentDTO> documentDTOs = documentService.listByIds(documentsIds);
